@section('header')
    <header class="main-header">
        <!-- Logo -->
        <a href="index2.html" class="logo"><b>Admin</b>IT</a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ asset('assets/admins/dist/img/user2-160x160.jpg') }}" class="user-image"
                                alt="User Image" />
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="{{ asset('assets/admins/dist/img/user2-160x160.jpg') }}" class="img-circle"
                                    alt="User Image" />
                                <p>
                                    {{ Auth::user()->name }}
